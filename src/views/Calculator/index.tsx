                  ...
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    ...
                    <Box color="text.secondary" className="calculator-card-metrics">
                      {isAppLoading ? (
                        ...
                        <div>
                          <Typography className="metric-body">{totalBalance} sDERPFI</Typography>
                          {
                            /*Number(pearlBalance) > 0*/ true ? (
                              <div>
                                <Divider />
                                <Typography className="metric-sub">{trimmedBondedBalance} sDERPFI</Typography>
                  ...
                  <Box className="data-row">
                    ...
                    <Typography className="data-row-value">
                      {isAppLoading ? (
                        ...
                        <>{new Intl.NumberFormat('en-US').format(Number(rewardsEstimation))} sDERPFI</>
                      )}
                    </Typography>
                  </Box>
                  <Box className="data-row">
