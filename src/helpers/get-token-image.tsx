...
import IconActiveBuyClamImage from 'src/components/Sidebar/NavContent/icons/images/buy-clam/active.png';
...
export function getCLAMTokenImage(size: number = 32) {
  const style: CSSProperties = { height: size, width: size, verticalAlign: 'middle' };
  return <img src={IconActiveBuyClamImage} />;
}
...
export function getPEARLTokenImage(size: number = 32) {
  const style: CSSProperties = { height: size, width: size, verticalAlign: 'middle' };
  return <img src={IconDefaultImage} width="32px" />;
}
