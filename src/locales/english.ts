  ...
  translation: {
    ...
    dashboard: {
      ...
      tooltipInfoMessages: {
        ...
        holder: 'Holders, represents the total number of otters (sDERPFI holders)',
        staked: 'CLAM Staked, is the ratio of sDERPFI to CLAM (staked vs unstaked)',
        ...
        runway:
          'Runway, is the number of days sDERPFI emissions can be sustained at a given rate. Lower APY = longer runway',
        currentIndex:
          'The current index tracks the amount of sDERPFI accumulated since the beginning of staking. Basically, how much sDERPFI one would have if they staked and held a single CLAM from day 1.',
      },
    },
    // src\views\Bond
    bonds: {
      ...
      purchase: {
        ...
        fourFourInfo:
          'Note: The (4, 4) bond will stake all CLAMs at the start, so you will earn all rebase rewards during the vesting term. Once fully vested, you will only be able to claim sDERPFI.',
        approvalInfo:
    ...
    // src\views\Stake
    stake: {
      clamStaking: 'DERPFI Staking',
      chestAPY: 'Max + ',
      chestAPYInfo: 'Additional APY for locking 180-day in pearl chest.',
      connectWalletDescription: 'Connect your wallet to stake DERPFI tokens!',
      approvalInfo:
      ...
      infoTooltips: {
        sClamBalance: 'The amount of sDERPFI in your wallet, currently available for wrapping or unstaking.',
        sClamBonded:
          'The total amount of sDERPFI currently vested in bonds. Will be available for wrapping or unstaking once the vesting period is finished.',
        pearl:
          'The amount of PEARL in your wallet. This value is multiplied by the Current Index to find the equivalent sDERPFI balance, which is included in the total above. Pearls locked in Chests are currently not included.',
        stakedBalance:
          'The sum total of sDERPFI in your wallet, vested in bonds, and the equivalent sDERPFI value of your held PEARL.',
        nextReward:
          'Total sDERPFI rewards which will be earned from your sDERPFI balance, bonded sDERPFI, and PEARL balance upon the next rebase.',
      },
    },
    // src\views\Wrap
    wrap: {
      wrapsClam: 'Wrap sDERPFI',
      connectWalletDescription: 'Connect your wallet to wrap your sDERPFI!',
      approvalInfo:
      ...
      description:
        'PEARL is an index-adjusted wrapper for sDERPFI. Some people may find this useful for cross-blockchain purposes. Unlike your sDERPFI balance, your PEARL balance will not increase over time. When PEARL is unwrapped, you receive sDERPFI based on the latest (ever-increasing) index, so the total yield is the same.',
    ...
    calculator: {
      ...
      yoursClamBalance: 'Your sDERPFI Balance',
      sClamAmount: 'sDERPFI Amount',
      purchasePrice: 'DERPFI Price at Purchase ($)',
      futurePrice: 'Future DERPFI Market Price ($)',
      results: 'Results',
      initialInvestment: 'Your initial investment',
      currentWealth: 'Current wealth',
      rewardEstimation: 'DERPFI rewards estimation',
    ...
    nft: {
      ...
      safehandDescription:
        'Awarded to every Otter who has staked for a minimum of 2 weeks with greater than 4 sDERPFI on the drop date.',
      furryhandDescription:
        'Awarded to every Otter who has staked for a minimum of 2 weeks with more than 40 sDERPFI on the drop date',
      stonehandDescription: 'Awarded to wallets with over 56 sDERPFI that have staked from 11/9 to drop date.',
      diamondhandDescription:
        'Awarded for staking the full amount of CLAM from IDO or launch date (11/3, with a minimum of 20 sDERPFI) to drop date',
    ...
    pearlChests: {
      title: 'PEARL Chests',
      description:
        'PEARL Chests are like personal vaults where you can lock your PEARLs. Once your PEARLs are put into a Chest, they will be locked for a certain period of time, but will also yield a lot more DERPFIs.',
      readMore: 'Read More',
      locked: 'Locked',
      unlocked: 'Unlocked',
