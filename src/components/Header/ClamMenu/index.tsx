...
import { ReactComponent as ClamIcon } from '../../../assets/icons/DERPFI.svg';
...
const BuyButton = ({ text }: { text: string }) => {
  ...
  return <CustomButton type="outline" color="text.primary" text={`${text} DERPFI`} />;
};
              ...
              <Paper className={`${styles.popperMenu} ohm-menu`} elevation={1}>
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    >
                      <Typography className="buy-text">DERPFI</Typography>
                    </Button>
                    <Button
                      variant="text"
                      size="large"
                    ...
                    >
                      <Typography className="buy-text">sDERPFI</Typography>
                    </Button>
                    <Button
                      variant="text"
                      size="large"
